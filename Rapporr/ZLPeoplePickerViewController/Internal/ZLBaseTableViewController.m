...
-(UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(10, 5, tableView.frame.size.width, 19)];
    ...
    if ((NSInteger)[[self.partitionedContacts
        ...
        sectionTitle = [[[LRIndexedCollationWithSearch currentCollation] sectionTitles]
                      objectAtIndex:section];
    }
...
- (void)configureCell:(UITableViewCell *)cell forContact:(APContact *)contact {
    ...
    if (IS_IPHONE_4) {
        [attributedString addAttribute:NSFontAttributeName
                                 value:ROBOTO_LIGHT(15)
                                 range:rangeToHightlight];
    }else{
        [attributedString addAttribute:NSFontAttributeName
                                 value:ROBOTO_LIGHT(17)
                                 range:rangeToHightlight];
    }
