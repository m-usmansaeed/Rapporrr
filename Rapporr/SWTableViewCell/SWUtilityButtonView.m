...
- (void)setUtilityButtons:(NSArray *)utilityButtons
{
    ...
    [self setUtilityButtons:utilityButtons WithButtonWidth:kUtilityButtonWidthDefault requirePaddingForSectionIndexer:NO];
}

- (void)setUtilityButtons:(NSArray *)utilityButtons WithButtonWidth:(CGFloat)width requirePaddingForSectionIndexer:(BOOL)requirePadding
{
    ...
    if (utilityButtons.count)
    {
        ...
        if (requirePadding) {
            // self added 15px padding from right edge to compensate section indexer. 🙄
            [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"[precedingView]-15-|"
                                                                         options:0L
                                                                         metrics:nil
