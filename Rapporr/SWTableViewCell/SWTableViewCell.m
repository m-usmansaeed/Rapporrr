...
- (void)setLeftUtilityButtons:(NSArray *)leftUtilityButtons WithButtonWidth:(CGFloat) width
{
    ...
    [self.leftUtilityButtonsView setUtilityButtons:leftUtilityButtons WithButtonWidth:width requirePaddingForSectionIndexer:NO];
...
- (void)setRightUtilityButtons:(NSArray *)rightUtilityButtons WithButtonWidth:(CGFloat)width requirePaddingForSectionIndexer:(BOOL)requirePadding
{
    _rightUtilityButtons = rightUtilityButtons;
    
    [self.rightUtilityButtonsView setUtilityButtons:rightUtilityButtons WithButtonWidth:width requirePaddingForSectionIndexer:requirePadding];
