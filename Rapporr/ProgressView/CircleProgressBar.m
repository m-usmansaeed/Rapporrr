...
#define DefaultHintTextFont [UIFont fontWithName:@"HelveticaNeue-CondensedBlack" size:5.0f]
...
// Animation Constants
const CGFloat AnimationChangeTimeDuration = 1.5f;
...
- (UIFont*)hintTextFontForDrawing {
    return (_hintTextFont != nil ? _hintTextFont : ROBOTO_LIGHT(8));
}
...
//    _animationTimer = [NSTimer scheduledTimerWithTimeInterval:AnimationChangeTimeStep repeats:YES block:^(NSTimer * _Nonnull timer) {
        [self updateProgressBarForAnimation];
//    }];
