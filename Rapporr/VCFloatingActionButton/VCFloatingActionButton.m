...
-(void) setupButton
{
    ...
    vsview.layer.opacity = 1.0;
    
    _bgView = [[UIView alloc]initWithFrame:[UIScreen mainScreen].bounds];
    _bgView.backgroundColor = [UIColor colorWithWhite:0 alpha:1.0];
    _bgView.alpha = 0;
...
-(void)handleTap:(id)sender //Show Menu
{
    ...
    VCFloatingActionButton *vCFloatingActionButton = (VCFloatingActionButton*)[sender view];
    
    NSLog(@"%ld",(long)vCFloatingActionButton.tag);
    
    [delegate didMenuButtonTapped:(VCFloatingActionButton*)[sender view]];
    //    }
    ...
    [UIView animateWithDuration:animationTime/2 animations:^
     {
         ...
         self.pressedImageView.alpha = 1.0f;
         self.pressedImageView.transform = CGAffineTransformMakeRotation(-M_PI);
