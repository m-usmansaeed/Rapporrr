...
@implementation LocationExtandedCell
...
//        self.sepratorView.hidden = true;
    ...
    [self.locationImageView setImageWithURL:imageUrl placeholderImage:message.placeHolderImage options:SDWebImageRetryFailed usingActivityIndicatorStyle:UIActivityIndicatorViewStyleGray];
