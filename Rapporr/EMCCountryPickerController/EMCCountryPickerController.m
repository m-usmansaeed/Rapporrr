...
static const CGFloat kEMCCountryCellControllerMinCellHeight = 60;
...
- (void)viewDidLoad
{
    ...
    UIView* statusBg = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 475, 20)];
    statusBg.backgroundColor = [UIColor colorWithRed:0.996 green:0.341 blue:0.129 alpha:1.0];
    
    self.title = @"Select Country";
    
    //Add the view behind the status bar
    [rootView addSubview:statusBg];
}
...
- (void)loadView
{
    ...
    rootView = [[UIView alloc] initWithFrame:CGRectMake(0, 140, screenWidth, screenHeight-40)];
    [rootView setBackgroundColor:[UIColor whiteColor]];
    rootView.autoresizesSubviews = YES;
    
    countryTable = [[UITableView alloc] initWithFrame:CGRectMake(0, 100, [rootView frame].size.width, [rootView frame].size.height)];
    ...
    searchBar = [[UISearchBar alloc] initWithFrame:CGRectMake(0, 60, [rootView frame].size.width, 40)];
    ...
    [Utils prepareSearchBarUI:searchBar];
    ...
    displayController.searchBar.showsCancelButton = NO;
    ...
    UIView *seprator = [[UIView alloc]initWithFrame:CGRectMake(0, countryTable.frame.origin.y-1, [UIScreen mainScreen].bounds.size.width, 1)];
    
    [seprator setBackgroundColor:App_OrangeColor];
//    [rootView addSubview:seprator];
    ...
    [button setTitleColor:[UIColor colorWithRed:0.996 green:0.341 blue:0.129 alpha:1.0] forState:UIControlStateNormal];

    
    button.frame = CGRectMake(screenWidth-80.0, 20, 80, 42.0);
    [rootView addSubview:button];
    
    UILabel *titleLbl = [[UILabel alloc] initWithFrame:CGRectMake(0, 20, screenWidth, 42)];
    titleLbl.text = @"";
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.textLabel setFont:ROBOTO_LIGHT(17)];
